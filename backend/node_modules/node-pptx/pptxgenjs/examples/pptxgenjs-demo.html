...
<head>
	...
	<script type="text/javascript" src="pptxgenjs-demo.js"></script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			// STEP 4: Show version
			{
				...
				$('#infoBar > div:last-child').append("<span title='"+ JSON.stringify(pptx.charts) +"'>pptx.charts = "+ Object.keys(pptx.charts).length +'</span>');
				$('#infoBar > div:last-child').append("<span title='"+ JSON.stringify(pptx.colors) +"'>pptx.colors = "+ Object.keys(pptx.colors).length +'</span>');
				$('#infoBar > div:last-child').append('<span>pptx.shapes = '+ Object.keys(pptx.shapes).length +'</span>');
			}
		...
		<div id="navTabs" class="modernTabs">
			...
			<div id="tab1" class="active" data-title="Intro">
				<div id="infoBar" class="table">
					<div style="width:40%">
						Library Version: <span id="getVersion"></span>
					</div>
				...
				<div class="sectionBox">
					<div class="sectionCont">
						<fieldset>
							...
							<h3>Slide 1</h3>
							<div class="chkRow"><div class="svgCheck"></div>Vertical/Horizontal bars</div>
							<h3>Slide 2</h3>
							<div class="chkRow"><div class="svgCheck"></div>Grid/Axis options</div>
							<h3>Slide 3</h3>
							<div class="chkRow"><div class="svgCheck"></div>Stacked/PercentStacked Bars</div>
							<h3>Slide 4</h3>
							<div class="chkRow"><div class="svgCheck"></div>Lots of Bars</div>
							<h3>Slide 5</h3>
				...
				<div class="sectionBox">
					<div class="sectionCont">
						<fieldset>
							...
							<div class="chkRow"><div class="svgCheck"></div>Pre-encoded image using `data:[base64]`</div>
							<div class="chkRow"><div class="svgCheck"></div>Hyperlinked Image</div>
						</fieldset>
						<fieldset>
							<legend>Image Sizing</legend>
							<h3>Slide 2</h3>
							<div class="chkRow"><div class="svgCheck"></div>Sizing: Contain</div>
							<div class="chkRow"><div class="svgCheck"></div>Sizing: Cover</div>
							<div class="chkRow"><div class="svgCheck"></div>Sizing: Crop</div>
						</fieldset>
						<fieldset>
				...
				<div class="sectionBox">
					<div class="sectionCont">
						<fieldset>
							...
							<h3>Slide 1</h3>
							<div class="chkRow"><div class="svgCheck"></div>Shapes: Rectangle, Line, Oval, Triangle</div>
							<div class="chkRow"><div class="svgCheck"></div>Shapes: Flipped, With and Without Text</div>
							<div class="chkRow"><div class="svgCheck"></div>Shape Borders</div>
				...
				<div class="sectionBox">
					<div class="sectionCont">
						...
						<fieldset style="height:auto">
							...
							<h3>Slide 5</h3>
							<div class="chkRow"><div class="svgCheck"></div>Cell Text Formatting Overview</div>
							<h3>Slide 6</h3>
							<div class="chkRow"><div class="svgCheck"></div>Cell Text Formatting Examples 2</div>
						</fieldset>
						<fieldset style="height:auto">
				...
				<div class="sectionBox">
					<div class="sectionCont">
						<fieldset>
							...
							<h3>Slide 1</h3>
							<div class="chkRow"><div class="svgCheck"></div>TITLE_SLIDE</div>

							<h3>Slide 2</h3>
							<div class="chkRow"><div class="svgCheck"></div>MASTER_SLIDE</div>

							<h3>Slide 3</h3>
							<div class="chkRow"><div class="svgCheck"></div>MASTER_SLIDE</div>

							<h3>Slide 4</h3>
							<div class="chkRow"><div class="svgCheck"></div>THANKS_SLIDE</div>
						</fieldset>
						<fieldset>
